          ...
          <div className="flex items-center gap-3">
            ...
            <Tooltip delayDuration={300}>
              <TooltipTrigger asChild>
                <Button
                  size="sm"
                  className={`min-w-[8.5rem] ${!titleHasText && !createIssue.isPending ? 'opacity-50 cursor-not-allowed' : ''} ${createIssue.isPending ? 'opacity-50 cursor-not-allowed' : ''} ${buttonShake ? 'animate-[shake_0.5s_ease-in-out]' : ''}`}
              ...
              <TooltipContent side="top" className="max-w-[240px] text-xs">
                {!titleHasText ? "Please enter a title to create an issue" : createIssue.isPending ? "Creating issue, please wait..." : "Click to create issue"}
              </TooltipContent>
            </Tooltip>
          </div>
        </div>
